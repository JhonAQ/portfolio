...
type TrajectoryByLocale = Record<Locale, TrajectoryItem[]>;

export const trajectory: TrajectoryByLocale = {
  es: [
    {
      type: "work",
  ...
  en: [
    {
      ...
      flags: ["mx"],
      subtitle: "ACRU (Mexico) | Misioneros Digitales",
      date: "2026",
      description:
        "Built internal systems for the organization. Delivered custom digital solutions, including bespoke WordPress plugins.",
      icon: "Globe",
      tech: ["Laravel", "PHP", "Flutter"],
    },
    {
      ...
      subtitle: "Management System 'Brigadapp'",
      date: "2026",
      description:
        "Created and sold 'Brigadapp', a full management system for an educational institution. Managed 50 prefects and incident reports, eliminating paper usage entirely.",
      icon: "Briefcase",
      tech: ["TypeScript", "Supabase", "Next.js"],
    },
    {
      ...
      title: "Software Developer",
      flags: ["pe", "no"],
      subtitle: "IELP (Lutheran Church - Peru)",
      date: "2025",
      description:
        "Led the organization's digital transformation. Built an interactive landing page for the national youth camp (Radical) and shipped a hymnal mobile app now in production.",
      icon: "HeartHandshake",
      tech: ["PostgreSQL", "Next.js", "React Native", "Expo"],
    },
    {
      ...
      title: "Training Camp Argentina 2025",
      flags: ["ar"],
      subtitle: "High-Performance Training | UTN Santa Fe",
      date: "2025",
      description:
        "Joined a two-week immersive camp with top competitive programmers in LATAM at UTN. Sharpened graph theory, dynamic programming, and advanced algorithms.",
      icon: "Terminal",
      image: "/images/education/training-camp.png",
      tech: ["C++", "Python"],
    },
    {
      type: "award",
      label: "Competition",
      title: "PeruHub Hackathon",
      subtitle: "Participant Developer | Unity Peru (Lima)",
      date: "2025",
      description:
        "Participated in Unity Peru's tech event, building innovative solutions alongside talented teams nationwide.",
      icon: "Trophy",
      tech: [],
    },
    {
      type: "award",
      label: "Competition",
      title: "InnovaSur Hackathon",
      subtitle: "Creator of 'Ayni' Project | UCSP",
      date: "2025",
      description:
        "Led the creation of 'Ayni' representing UNSA, a platform to improve access to health monitoring in vulnerable areas without nearby medical centers.",
      icon: "Trophy",
      image: "/images/education/project-ayni.png",
      tech: ["Tailwind CSS", "TypeScript", "Figma"],
    },
    {
      type: "volunteer",
      label: "University Volunteering",
      title: "Active Member & Developer",
      subtitle: "CEIS, IEEE & ACM Student Chapters",
      date: "Since 2024",
      description:
        "Active member of CEIS and IEEE/ACM student chapters, contributing to technical growth and community organization.",
      icon: "Users",
      tech: [],
    },
    {
      ...
      label: "Freelance",
      title: "Freelance Developer",
      subtitle: "Attendance System 'Educheck'",
      date: "2024",
      description:
        "Built and commercially sold 'Educheck', an intelligent attendance and automated parent notification system. Awarded at the Eureka science fair.",
      icon: "Briefcase",
      image: "/images/education/educheck.png",
      tech: ["Supabase", "Next.js"],
    },
    {
      type: "cert",
      label: "Certification",
      title: "Tech Certifications: Cloud & DB",
      subtitle: "Google Cloud Foundations & Oracle APEX",
      date: "2024",
      description:
        "Earned international credentials in cloud infrastructure fundamentals (GCP) and rapid enterprise app development with Oracle APEX.",
      icon: "Cloud",
      tech: [],
    },
    {
      type: "award",
      label: "Competition",
      title: "Competitive Programming (RPC & IEEEXtreme)",
      subtitle: "Top 5 Peru | Top 20 Latam",
      date: "2023 - 2024",
      description:
        "Competed at the highest level in RPC and 24-hour marathons (IEEEXtreme). Excelled in algorithmic optimization under pressure, placing among the best in the region.",
      icon: "Code2",
      tech: ["C++", "Python"],
    },
    {
      type: "work",
      label: "Work",
      title: "Automation and Data Scripting",
      subtitle: "Municipality of Cabana | INDECI System",
      date: "2023",
      description:
        "Developed advanced scripts to automate and process critical data for the INDECI system, reducing manual effort from two months to just three days.",
      icon: "Database",
      tech: ["Python"],
    },
    {
      type: "volunteer",
      label: "Volunteering",
      title: "STEM Mentor & Educational Volunteer",
      subtitle: "College of Engineers of Peru",
      date: "2023",
      description:
        "Led Python mentorship sessions for teenagers, culminating in organizing a competitive programming contest to foster young tech talent.",
      icon: "Users",
      image: "/images/education/stem-mentor.png",
      tech: ["Python"],
    },
    {
      ...
      date: "Since 2023",
      description:
        "Pursuing a rigorous academic formation with focus on software architecture, data engineering, mathematical analysis, and complex system design patterns.",
      icon: "GraduationCap",
      tech: [],
    },
  ],
