...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1C] text-slate-300 font-sans selection:bg-indigo-500/30 relative z-0 overflow-x-hidden">
      ...
      <style>{`
        ...
        ::-webkit-scrollbar-thumb {
          ...
          border-radius: 10px;
          border: 2px solid #0A0F1C; /* Espacio alrededor del thumb */
        }
        ::-webkit-scrollbar-thumb:hover {
          background: #4f46e5; /* Indigo brillante al pasar el cursor */
        }
      ...
      <div className="fixed top-6 left-1/2 transform -translate-x-1/2 w-[95%] max-w-5xl z-50">
        <nav className="bg-[#111827]/90 backdrop-blur-md border border-white/5 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.3)] px-6 py-3 flex justify-between items-center transition-all duration-300 relative">
          
          <span className="font-bold text-xl tracking-tight text-white pl-2">Jhon<span className="text-indigo-500">AQ.</span></span>
          ...
          <div className="hidden lg:flex items-center">
            ...
            <div className="flex space-x-7 mr-6">
              {['home', 'about', 'education', 'projects', 'contact'].map((item) => (
                <button
                  ...
                  className={`uppercase text-[11px] font-extrabold tracking-widest transition-colors hover:text-white ${
                    activeSection === item ? 'text-indigo-400' : 'text-slate-400'
                  }`}
                >
            ...
            <div className="flex items-center space-x-5 ml-6">
              <a href="mailto:jariasq@unsa.edu.pe" className="text-slate-400 hover:text-white transition-colors" title="Email">
                <Mail size={16} strokeWidth={2.5} />
              </a>
              <a href="https://linkedin.com/in/jhon-aq" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white transition-colors" title="LinkedIn">
                <Linkedin size={16} strokeWidth={2.5} />
              </a>
              <a href="https://github.com/JhonAQ" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white transition-colors" title="GitHub">
                <Github size={16} strokeWidth={2.5} />
              </a>
              
              <button 
                onClick={() => scrollTo('contact')}
                className="ml-4 bg-[#1A1F2E] hover:bg-[#2A3143] text-white text-[11px] font-extrabold tracking-widest px-6 py-2.5 rounded-full border border-white/5 transition-all shadow-md uppercase"
              >
                Hire Me
              </button>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="absolute top-[120%] left-0 w-full bg-[#111827]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-5 flex flex-col gap-4 shadow-2xl lg:hidden animate-fade-in-up">
              {['home', 'about', 'education', 'projects', 'contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollTo(item)}
                  className={`uppercase text-[12px] font-extrabold tracking-widest text-left px-4 py-3 rounded-xl transition-colors ${
                    activeSection === item ? 'bg-indigo-500/10 text-indigo-400' : 'text-slate-400 hover:bg-white/5 hover:text-white'
                  }`}
                >
                  {item === 'home' ? 'Home' : item === 'about' ? 'About' : item === 'education' ? 'Educación' : item === 'projects' ? 'Work' : 'Contact'}
                </button>
      ...
      <section id="home" className="pt-36 md:pt-48 pb-20 px-4 max-w-6xl mx-auto min-h-[100dvh] flex flex-col justify-center relative">
        <div className="w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-8">
          ...
          <div className="max-w-2xl flex-1 animate-fade-in-up">
            <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight mb-2 hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300">
            ...
            <p className="text-lg text-slate-400 mb-10 max-w-xl leading-relaxed hover:text-slate-200 transition-colors duration-300">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button 
                onClick={() => scrollTo('contact')}
                className="bg-indigo-500 text-white px-7 py-3 rounded-md font-bold hover:bg-indigo-600 transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(99,102,241,0.2)] hover:shadow-[0_0_30px_rgba(99,102,241,0.4)] hover:-translate-y-1 uppercase text-[13px] tracking-wide"
              >
              ...
              <a 
                ...
                download
                className="bg-transparent border border-white/20 text-white px-7 py-3 rounded-md font-bold hover:bg-white/5 hover:border-indigo-400 transition-all flex items-center gap-2 hover:-translate-y-1 uppercase text-[13px] tracking-wide"
              >
          ...
          <div className="relative flex-shrink-0 animate-fade-in-up animation-delay-200 mb-6 md:mb-0 flex flex-col">
            <div className="relative w-64 h-64 md:w-[320px] md:h-[320px] rounded-2xl p-[2px] bg-gradient-to-br from-indigo-500/80 via-purple-500/20 to-transparent shadow-[0_0_35px_rgba(99,102,241,0.25)] group hover:shadow-[0_0_50px_rgba(99,102,241,0.4)] transition-all duration-500">
              <div className="w-full h-full rounded-2xl bg-[#0A0F1C] overflow-hidden relative">
                <img 
            ...
            <div className="mt-5 space-y-2.5 w-full md:max-w-[320px] mx-auto px-2 font-medium">
              <a href="mailto:jariasq@unsa.edu.pe" className="flex items-center gap-3 text-sm text-slate-400 hover:text-white transition-colors group">
                <Mail size={16} className="text-slate-500 group-hover:text-indigo-400 transition-colors" /> 
                jariasq@unsa.edu.pe
              </a>
              <div className="flex items-center gap-3 text-sm text-slate-400 group cursor-default">
                <MapPin size={16} className="text-slate-500 group-hover:text-indigo-400 transition-colors" /> 
                Arequipa, Perú
              </div>
              <a href="https://github.com/JhonAQ" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-sm text-slate-400 hover:text-white transition-colors group">
                <Github size={16} className="text-slate-500 group-hover:text-indigo-400 transition-colors" /> 
                JhonAQ
              </a>
            </div>
          </div>
      ...
      <section id="about" className="py-24 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="space-y-6 text-slate-400 text-lg leading-relaxed reveal delay-100">
              ...
              <div className="bg-indigo-950/30 border border-indigo-500/20 p-5 rounded-lg flex items-start gap-4 hover:bg-indigo-900/40 hover:border-indigo-500/40 transition-all duration-300 group">
                <Award className="text-indigo-400 shrink-0 mt-1 group-hover:text-indigo-300 group-hover:drop-shadow-[0_0_8px_rgba(99,102,241,0.8)] transition-all" size={24} />
                <p className="text-sm text-indigo-200 group-hover:text-white transition-colors">
                  <strong className="text-white block mb-1">Dato destacado:</strong> 
                  Fui reconocido entre los 40 usuarios de GitHub más activos en todo el Perú, reflejo de mi constancia y pasión por el desarrollo.
                </p>
              </div>
            </div>
            ...
            <div className="reveal delay-200">
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <span 
                    key={index} 
                    className="flex items-center gap-2.5 px-4 py-2 bg-white/5 text-slate-300 rounded-md font-medium text-sm border border-white/10 hover:border-indigo-500/50 hover:bg-indigo-500/10 hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] transition-all cursor-default group"
                  >
                    <img 
                      src={skill.icon} 
                      alt={skill.name} 
                      className="w-4 h-4 opacity-60 group-hover:opacity-100 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.9)] transition-all brightness-0 invert" 
        ...
        <div className="relative w-full py-10 mt-16 overflow-hidden flex items-center reveal delay-300">
          <div className="absolute inset-y-0 left-0 w-32 md:w-64 bg-gradient-to-r from-[#0A0F1C] to-transparent z-10 pointer-events-none"></div>
          <div className="absolute inset-y-0 right-0 w-32 md:w-64 bg-gradient-to-l from-[#0A0F1C] to-transparent z-10 pointer-events-none"></div>
          
          <div className="flex w-max animate-scroll">
            <div className="flex gap-12 md:gap-16 px-6 md:px-8 items-center justify-center">
              {[...skills, ...skills].map((skill, index) => (
                <div key={index} className="drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] transition-all duration-300 cursor-pointer group flex items-center justify-center min-w-[5rem]" title={skill.name}>
                  <img src={skill.icon} alt={skill.name} className="h-20 md:h-28 w-auto transform group-hover:scale-110 transition-transform duration-300 brightness-0 invert" />
                </div>
              ))}
            </div>
            <div className="flex gap-12 md:gap-16 px-6 md:px-8 items-center justify-center">
              {[...skills, ...skills].map((skill, index) => (
                <div key={`clone-${index}`} className="drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] transition-all duration-300 cursor-pointer group flex items-center justify-center min-w-[5rem]" title={skill.name}>
                  <img src={skill.icon} alt={skill.name} className="h-20 md:h-28 w-auto transform group-hover:scale-110 transition-transform duration-300 brightness-0 invert" />
                </div>
              ))}
            </div>
      ...
      <section id="education" className="py-24 border-t border-white/5 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto reveal delay-100">
            <div className="relative border-l border-indigo-500/30 ml-3 md:ml-6 space-y-12">
              <div className="relative pl-8 md:pl-10 group">
                <div className="absolute -left-[9px] top-1 h-4 w-4 rounded-full bg-[#0A0F1C] border-2 border-indigo-500 group-hover:bg-indigo-500 transition-colors"></div>
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-2 gap-2">
                  <h3 className="text-xl font-bold text-white group-hover:text-indigo-300 transition-colors">Universidad Nacional de San Agustín</h3>
                  <span className="text-sm font-medium text-indigo-400">Presente</span>
                </div>
                <h4 className="text-lg font-medium text-slate-400 mb-3 group-hover:text-slate-300 transition-colors">Estudiante de Ciencias de la Computación</h4>
                <p className="text-slate-500 leading-relaxed text-sm group-hover:text-slate-300 transition-colors">
                  Formación académica enfocada en estructuras de datos, análisis de algoritmos, y desarrollo de software.
                </p>
              </div>

              <div className="relative pl-8 md:pl-10 group cursor-default">
                <div className="absolute -left-[9px] top-1 h-4 w-4 rounded-full bg-[#0A0F1C] border-2 border-indigo-500 group-hover:bg-indigo-500 group-hover:shadow-[0_0_10px_rgba(99,102,241,0.8)] transition-all"></div>
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-2 gap-2">
                  <h3 className="text-xl font-bold text-white group-hover:text-indigo-300 transition-colors">Hackaton InnovaSur</h3>
                  <span className="text-sm font-medium text-indigo-400">2025</span>
                </div>
                <h4 className="text-lg font-medium text-slate-400 mb-3 group-hover:text-slate-300 transition-colors">Participante & Desarrollador</h4>
                <p className="text-slate-500 leading-relaxed text-sm group-hover:text-slate-300 transition-colors">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-20 md:gap-32">
            {projects.slice(0, 3).map((project, index) => (
              ...
              >
                <div className="w-full lg:w-1/2 relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] group-hover:border-indigo-500/50 group-hover:shadow-[0_0_50px_rgba(99,102,241,0.4)] transition-all duration-500">
                ...
                <div className={`w-full lg:w-1/2 flex flex-col ${index % 2 === 1 ? 'lg:items-start' : 'lg:items-end'} text-left ${index % 2 === 1 ? 'lg:text-left' : 'lg:text-right'}`}>
                  <h4 className="text-indigo-400 font-bold tracking-widest text-xs uppercase mb-2">Proyecto Destacado</h4>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 group-hover:text-indigo-300 transition-colors">
                    {project.title}
                  </h3>
                  
                  <div className="w-full bg-[#111827]/90 backdrop-blur-md border border-white/5 group-hover:border-indigo-500/30 p-6 md:p-8 rounded-xl mb-6 shadow-xl group-hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] transition-all duration-500 relative z-20">
                    <p className="text-slate-400 text-sm md:text-base leading-relaxed text-left">
                      {project.description}
                    </p>
                  </div>

                  <div className={`flex flex-wrap gap-3 mb-8 ${index % 2 === 1 ? 'justify-start' : 'lg:justify-end'}`}>
                    {project.tech.map((tech, i) => (
                      <span key={i} className="text-xs font-mono bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 px-3 py-1.5 rounded-full whitespace-nowrap">
                        {tech}
                      </span>
                    ))}
                  </div>

                  <div className={`flex items-center gap-6 ${index % 2 === 1 ? 'justify-start' : 'lg:justify-end'}`}>
                    <a href={project.github} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-indigo-400 font-bold text-sm tracking-wide transition-colors">
                      <Github size={20} /> Código
                    </a>
                    <a href={project.demo} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-indigo-400 font-bold text-sm tracking-wide transition-colors">
          ...
          <div className="mt-40 reveal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projects.slice(3).map((project, index) => (
                <div key={index} className={`reveal delay-${(index % 3 + 1) * 100} bg-[#111827]/60 backdrop-blur-sm border border-white/5 hover:border-indigo-500/40 rounded-2xl overflow-hidden flex flex-col group transition-all duration-500 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)]`}>
                  ...
                  <div className="p-7 flex flex-col flex-grow">
                    <h4 className="text-xl font-bold text-white mb-3 group-hover:text-indigo-300 transition-colors">{project.title}</h4>
                    <p className="text-slate-400 text-sm leading-relaxed mb-6 flex-grow">{project.description}</p>
                    
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tech.map((tech, i) => (
                        <span key={i} className="text-[11px] font-mono bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 px-2.5 py-1 rounded-full whitespace-nowrap">{tech}</span>
                      ))}
                    </div>
                    
                    <div className="flex items-center gap-5 mt-auto pt-5 border-t border-white/5">
                      <a href={project.github} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-indigo-400 font-bold text-sm transition-colors"><Github size={18} /> Repo</a>
                      <a href={project.demo} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-slate-300 hover:text-indigo-400 font-bold text-sm transition-colors"><ExternalLink size={18} /> Demo</a>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section id="contact" className="py-32 border-t border-white/5 relative overflow-hidden reveal">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-start">
            ...
            <div>
              <h4 className="text-indigo-400 font-bold tracking-widest text-xs uppercase mb-3">¿Qué sigue?</h4>
              ...
              <div className="space-y-4 mb-10">
                {/* Tarjeta de Correo */}
                <a href="mailto:jariasq@unsa.edu.pe" className="flex items-center gap-4 p-4 rounded-xl bg-[#111827]/60 backdrop-blur-sm border border-white/5 hover:border-indigo-500/30 hover:bg-white/[0.02] transition-all group">
                  <div className="bg-indigo-500/10 p-3 rounded-lg text-indigo-400 group-hover:scale-110 group-hover:bg-indigo-500 group-hover:text-white transition-all">
                    <Mail size={20} />
                  </div>
                  <div>
                    <h5 className="text-sm font-semibold text-white">Correo Electrónico</h5>
                    <p className="text-sm text-slate-400">jariasq@unsa.edu.pe</p>
                  </div>
                </a>

                {/* Tarjeta de Ubicación */}
                <div className="flex items-center gap-4 p-4 rounded-xl bg-[#111827]/60 backdrop-blur-sm border border-white/5 transition-all">
                  <div className="bg-indigo-500/10 p-3 rounded-lg text-indigo-400">
                    <MapPin size={20} />
                  </div>
                  <div>
                    <h5 className="text-sm font-semibold text-white">Ubicación</h5>
                    <p className="text-sm text-slate-400">Arequipa, Perú (Remoto global)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-[#111827]/60 backdrop-blur-sm border border-white/5 transition-all">
                  ...
                  <div className="flex-1">
                    <h5 className="text-sm font-semibold text-white mb-1">Redes Sociales</h5>
                    <div className="flex gap-4">
                      <a href="https://github.com/JhonAQ" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-indigo-400 transition-colors text-sm font-medium">GitHub</a>
                      <a href="https://linkedin.com/in/jhon-aq" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-indigo-400 transition-colors text-sm font-medium">LinkedIn</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#111827]/80 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl relative">
              <h3 className="text-2xl font-bold text-white mb-6">Envíame un mensaje</h3>
              
              <form onSubmit={handleFormSubmit} className="space-y-5">
                <div className="grid md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-sm font-medium text-slate-400">Tu Nombre</label>
                    <input 
                      type="text" 
                      id="name" 
                      required
                      placeholder="Ej. Juan Pérez"
                      className="w-full bg-[#0A0F1C]/50 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium text-slate-400">Tu Correo</label>
                    <input 
                      type="email" 
                      id="email" 
                      required
                ...
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-medium text-slate-400">Asunto</label>
                  <input 
                    type="text" 
                    id="subject" 
                    required
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-medium text-slate-400">Mensaje</label>
                  <textarea 
                    id="message" 
                    rows="4" 
                    required
                    placeholder="Cuéntame sobre tu proyecto o lo que tienes en mente..."
                    className="w-full bg-[#0A0F1C]/50 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all resize-none"
                  ></textarea>
                </div>
                ...
                <button 
                  ...
                  className={`w-full py-4 rounded-lg font-bold text-sm tracking-wide uppercase transition-all flex justify-center items-center gap-2 ${
                    isSubmitted 
                      ...
                      : 'bg-indigo-500 text-white hover:bg-indigo-600 shadow-[0_0_20px_rgba(99,102,241,0.2)] hover:shadow-[0_0_30px_rgba(99,102,241,0.4)]'
                  }`}
                >
                  {isSubmitting ? (
                    <span className="flex items-center gap-2 animate-pulse">Enviando...</span>
                  ) : isSubmitted ? (
                    <span className="flex items-center gap-2"><CheckCircle size={18} /> Mensaje Enviado</span>
                  ) : (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            ...
            <div className="col-span-1 md:col-span-1">
              <span className="font-bold text-3xl tracking-tight text-white block mb-4">Jhon<span className="text-indigo-500">AQ.</span></span>
              ...
              <div className="flex items-center gap-4">
                <a href="https://github.com/JhonAQ" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white hover:scale-110 transition-all bg-white/5 p-2.5 rounded-full hover:bg-indigo-500/20 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                  <Github size={18} />
                </a>
                <a href="https://linkedin.com/in/jhon-aq" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white hover:scale-110 transition-all bg-white/5 p-2.5 rounded-full hover:bg-indigo-500/20 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                  <Linkedin size={18} />
                </a>
                <a href="mailto:jariasq@unsa.edu.pe" className="text-slate-400 hover:text-white hover:scale-110 transition-all bg-white/5 p-2.5 rounded-full hover:bg-indigo-500/20 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                  <Mail size={18} />
                </a>
              </div>
            </div>
            ...
            <div className="col-span-1 flex flex-col md:items-center">
              <div>
                <h4 className="text-white font-bold mb-4 uppercase text-xs tracking-widest">Navegación</h4>
                <ul className="space-y-3">
                  {['home', 'about', 'education', 'projects'].map((item) => (
                    <li key={item}>
                      <button 
                        onClick={() => scrollTo(item)}
                        className="text-slate-400 hover:text-indigo-400 text-sm font-medium transition-colors capitalize flex items-center gap-2 group"
                      >
            ...
            <div className="col-span-1 flex flex-col md:items-end justify-between">
              <button 
                onClick={scrollToTop}
                className="w-12 h-12 bg-indigo-500/10 hover:bg-indigo-500 text-indigo-400 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:-translate-y-2 group"
              ...
              <div className="text-left md:text-right mt-8 md:mt-0">
                <h4 className="text-white font-bold mb-2 uppercase text-xs tracking-widest">Status Actual</h4>
                <div className="flex items-center gap-2 text-sm text-slate-400 justify-start md:justify-end">
