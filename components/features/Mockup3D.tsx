...
const Mockup3D: React.FC<Mockup3DProps> = ({
  image,
  video,
  fit = "cover",
  background,
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`w-full h-8 flex items-center px-4 gap-2 border-b ${isDarkMode ? "bg-[#1e293b] border-white/10" : "bg-slate-200 border-slate-300"}`}
        >
        ...
        <div
          className={`relative ${!background ? (isDarkMode ? "bg-[#0A0F1C]" : "bg-white") : ""}`}
        ...
        >
          ...
          {video ? (
            ...
            <img
              src={image}
              alt="Project Mockup"
              className={`w-full aspect-video ${fit === "contain" ? "object-contain object-center" : "object-cover object-top"}`}
              onError={(e) => {
